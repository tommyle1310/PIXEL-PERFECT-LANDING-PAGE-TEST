...
document.addEventListener("DOMContentLoaded", () => {
  const presets = {
    ...
    "5": "bg-[#000] mt-8 py-[18px] flex-shrink-1 self-start leading-[1.3] md:px-[80px] text-md md:text-lg md:py-[18px] px-20 rounded-[4px] text-white hover:bg-[#333] duration-300",
